...
<a href="./permission_hierarchy.svg" target="_blank">
  <img src="./permission_hierarchy.svg" style={{background: "white", padding: "1em", borderRadius: "1em"}} />
</a>

If you are looking to implement permissions in a library, we highly recommend reading either the Stoat JavaScript SDK or the backend source code since all the routines are well commented and should be relatively easy to understand.
