...
```bash
git clone https://github.com/stoatchat/stoatchat
cd stoatchat
mise build
```
...
git clone --recursive https://https://github.com/stoatchat/for-legacy-web
cd revite
yarn
yarn build:deps
...
The Revolt backend is generally licensed under the [GNU Affero General Public License v3.0](https://github.com/stoatchat/stoatchat/blob/master/LICENSE).
